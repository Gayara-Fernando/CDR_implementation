# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 23:02:00 2023
...
save_results_to = '/common/statsgeneral/gayara/MOLI/Paclitaxel/results/classifier/'
max_iter = 100
torch.manual_seed(42)

GDSCE = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/GDSC_exprs.Paclitaxel.eb_with.PDX_exprs.Paclitaxel.tsv", sep = "\t", index_col=0, decimal = ",")
GDSCE = pd.DataFrame.transpose(GDSCE)
# Load GDSC response
GDSCR = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/GDSC_response.Paclitaxel.tsv", sep = "\t", index_col=0, decimal = ",")

PDXE = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/PDX_exprs.Paclitaxel.eb_with.GDSC_exprs.Paclitaxel.tsv", sep = "\t", index_col=0, decimal = ",")
PDXE = pd.DataFrame.transpose(PDXE)

PDXM = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/PDX_mutations.Paclitaxel.tsv", sep = "\t", index_col=0, decimal = ".")
PDXM = pd.DataFrame.transpose(PDXM)

PDXC = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/PDX_CNA.Paclitaxel.tsv", sep = "\t", index_col=0, decimal = ".")
PDXC = pd.DataFrame.transpose(PDXC)

GDSCM = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/GDSC_mutations.Paclitaxel.tsv", sep = "\t", index_col=0, decimal = ".")
GDSCM = pd.DataFrame.transpose(GDSCM)

GDSCC = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/GDSC_CNA.Paclitaxel.tsv", sep = "\t", index_col=0, decimal = ".")
...
PDXR = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/PDX_response.Paclitaxel.tsv", 
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCE.values, Y):
        ...
        title = 'Cost Paclitaxel iter = {}, fold = {}, mb_size = {},  hz_dim[1,2] = ({},{}), lr[E,M,C] = ({}, {}, {}), epoch = {}, wd = {}, lrCL = {}, rate4 = {}'.\
        ...
        title = 'AUC Paclitaxel iter = {}, fold = {}, mb_size = {},  hz_dim[1,2] = ({},{}), lr[E,M,C] = ({}, {}, {}), epoch = {}, wd = {}, lrCL = {}, rate4 = {}'.\
                      format(iters, k, mbs, hdm, zdm , lre, lrm, lrc, epch, wd, lrCL, rate)        
