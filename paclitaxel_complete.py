# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 22:58:51 2023
...
save_results_to = '/common/statsgeneral/gayara/MOLI/Paclitaxel/results/complete/'
torch.manual_seed(42)

max_iter = 50

GDSCE = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/GDSC_exprs.Paclitaxel.eb_with.PDX_exprs.Paclitaxel.tsv", 
                    sep = "\t", index_col=0, decimal = ",")
GDSCE = pd.DataFrame.transpose(GDSCE)

GDSCR = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/GDSC_response.Paclitaxel.tsv", 
                    sep = "\t", index_col=0, decimal = ",")

PDXE = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/PDX_exprs.Paclitaxel.eb_with.GDSC_exprs.Paclitaxel.tsv", 
                   sep = "\t", index_col=0, decimal = ",")
PDXE = pd.DataFrame.transpose(PDXE)

PDXM = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/PDX_mutations.Paclitaxel.tsv", 
                   sep = "\t", index_col=0, decimal = ".")
PDXM = pd.DataFrame.transpose(PDXM)

PDXC = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/PDX_CNA.Paclitaxel.tsv", 
                   sep = "\t", index_col=0, decimal = ".")
PDXC.drop_duplicates(keep='last')
PDXC = pd.DataFrame.transpose(PDXC)
PDXC = PDXC.loc[:,~PDXC.columns.duplicated()]

GDSCM = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/GDSC_mutations.Paclitaxel.tsv", 
                    sep = "\t", index_col=0, decimal = ".")
GDSCM = pd.DataFrame.transpose(GDSCM)


GDSCC = pd.read_csv("/common/statsgeneral/gayara/MOLI/Paclitaxel/all_data/GDSC_CNA.Paclitaxel.tsv", 
                    sep = "\t", index_col=0, decimal = ".")
