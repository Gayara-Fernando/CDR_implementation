# -*- coding: utf-8 -*-
"""
Created on Fri Jan 27 09:25:53 2023
...
save_results_to = '/common/statsgeneral/gayara/MOLI/Pan_drug/results/'
torch.manual_seed(42)

max_iter = 5

GDSCE = pd.read_csv("/common/statsgeneral/gayara/MOLI/Pan_drug/all_data/GDSC_exprs.z.EGFRi.tsv", 
                    sep = "\t", index_col=0, decimal = ",")
GDSCE = pd.DataFrame.transpose(GDSCE)

GDSCM = pd.read_csv("/common/statsgeneral/gayara/MOLI/Pan_drug/all_data/GDSC_mutations.EGFRi.tsv", 
                    sep = "\t", index_col=0, decimal = ".")
GDSCM = pd.DataFrame.transpose(GDSCM)
GDSCM = GDSCM.loc[:,~GDSCM.columns.duplicated()]

GDSCC = pd.read_csv("/common/statsgeneral/gayara/MOLI/Pan_drug/all_data/GDSC_CNA.EGFRi.tsv", 
                    sep = "\t", index_col=0, decimal = ".")
GDSCC.drop_duplicates(keep='last')
GDSCC = pd.DataFrame.transpose(GDSCC)
GDSCC = GDSCC.loc[:,~GDSCC.columns.duplicated()]

PDXEerlo = pd.read_csv("/common/statsgeneral/gayara/MOLI/Pan_drug/all_data/PDX_exprs.Erlotinib.eb_with.GDSC_exprs.Erlotinib.tsv", 
                   sep = "\t", index_col=0, decimal = ",")
PDXEerlo = pd.DataFrame.transpose(PDXEerlo)
PDXMerlo = pd.read_csv("/common/statsgeneral/gayara/MOLI/Pan_drug/all_data/PDX_mutations.Erlotinib.tsv", 
                   sep = "\t", index_col=0, decimal = ",")
PDXMerlo = pd.DataFrame.transpose(PDXMerlo)
PDXCerlo = pd.read_csv("/common/statsgeneral/gayara/MOLI/Pan_drug/all_data/PDX_CNA.Erlotinib.tsv", 
                   sep = "\t", index_col=0, decimal = ",")
...
PDXEcet = pd.read_csv("/common/statsgeneral/gayara/MOLI/Pan_drug/all_data/PDX_exprs.Cetuximab.eb_with.GDSC_exprs.Cetuximab.tsv", 
                   sep = "\t", index_col=0, decimal = ",")
PDXEcet = pd.DataFrame.transpose(PDXEcet)
PDXMcet = pd.read_csv("/common/statsgeneral/gayara/MOLI/Pan_drug/all_data/PDX_mutations.Cetuximab.tsv", 
                   sep = "\t", index_col=0, decimal = ",")
PDXMcet = pd.DataFrame.transpose(PDXMcet)
PDXCcet = pd.read_csv("/common/statsgeneral/gayara/MOLI/Pan_drug/all_data/PDX_CNA.Cetuximab.tsv", 
                   sep = "\t", index_col=0, decimal = ",")
...
GDSCR = pd.read_csv("/common/statsgeneral/gayara/MOLI/Pan_drug/all_data/GDSC_response.EGFRi.tsv", 
                    sep = "\t", index_col=0, decimal = ",")
